            ...
            <div class="col-sm-12 col-md-9 content-dados-cadastrais">
              ...
              <div class="row content-btn-gh">
                <div class="col-md-12 pull-left">
                  <?= Html::a('Voltar', ['agente'], ['class' => 'btn btn-default']) ?>
                  <?= Html::a('Imprimir', ['agente-ficha', 'id' => $model->id], ['class' => 'btn btn-default']) ?>
                  <?= Html::a('Atualizar', ['agente-atualizar', 'id' => $model->id], ['class' => 'btn btn-default']) ?>
                </div>
              </div>
            </div>
